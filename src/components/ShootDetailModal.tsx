...
import { 
  ...
  Building, User, ChevronRight, Download, Banknote, AlertCircle 
} from 'lucide-react';
      ...
      <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4 bg-black/60 dark:bg-black/80 backdrop-blur-md">
        ...
        >
          ...
          <div className="p-4 sm:p-6 space-y-6 overflow-y-auto max-h-[calc(92vh-140px)]">
            ...
            {/* Danger Zone: Delete Shoot */}
            <div className="p-4 rounded-2xl bg-rose-50/50 dark:bg-red-950/20 border border-rose-200/80 dark:border-red-900/30 flex items-center justify-between">
              <div>
                <h4 className="text-xs font-bold text-rose-800 dark:text-rose-300">Delete Shoot Record</h4>
                <p className="text-[11px] text-rose-600/80 dark:text-rose-400/70">Permanently remove this shoot, schedule slots, and ledger data.</p>
              </div>
              <button
                type="button"
                onClick={() => setShowDeleteConfirm(true)}
